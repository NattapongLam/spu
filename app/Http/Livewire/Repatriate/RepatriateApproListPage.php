...
class RepatriateApproListPage extends Component
{
    use WithPagination;
    ...
    protected $listeners = [
        'refreshRepatriateAppro' => '$refresh'
    ];
    ...
    public function render()
    {
        ...
        return view('livewire.repatriate.repatriate-appro-list-page',[
            'borr' => $borr
